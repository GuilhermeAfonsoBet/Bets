...
SNIPPET = '''
    ...
    try:
        ...
        try:
            ...
            _sum = {{}}
        out_lines.append(render_accounting_health_h3bup_section(health=_health, reconcile_summary=_sum))
        out_lines.append("\\n")
    except Exception as _e_acc_health:
        out_lines.append("## Accounting Health — H3BUP\\n\\n")
        out_lines.append(f"_indisponível: {{str(_e_acc_health)[:160]}}_\\n\\n")
    {end}
