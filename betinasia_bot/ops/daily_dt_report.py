...
def main() -> int:
    ...
    os.environ.setdefault("DAILY_WF_POLICY_CURRENT", "logs/wf_policy_current_dt.json")
    os.environ.setdefault("DAILY_WF_POLICY_HISTORY_DIR", "logs/policy_history_dt")
    os.environ.setdefault("DAILY_WF_POLICY_HISTORY_JSONL", "logs/wf_policy_history_dt.jsonl")
