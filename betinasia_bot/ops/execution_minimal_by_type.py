...
async def compute_minimal_by_type(
    *,
    ...
    for e in xs:
        ...
        if str(e.exec_side).strip().lower() == "lay" and odd is not None:
    ...
    return {
        ...
        "notes": [
            ...
            "Para Lay: valor apostado é stake; risco é liability (stake*(odd-1)). ROI principal é por liability; também reportamos ROI por stake.",
        ],
    }
