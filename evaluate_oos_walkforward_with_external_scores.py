...
- score atual (proba_raw/proba_cal via segment_score_col)
- score v1 externo (score_v1_cls_*_wf12), gerado por build_score_v1_weekly_scores.py

Saídas em /workspace/analysis_proba_raw/pro_portfolio_all:
- oos_walkforward_score_current_p10_p70_weekly.csv
- oos_walkforward_scorev1_logit_wf12_p10_p70_weekly.csv
- oos_walkforward_scorev1_hgb_wf12_p10_p70_weekly.csv
- oos_walkforward_score_compare_wf12_p10_p70_summary.csv
"""
...
def _run_wf(df: pd.DataFrame, score_col_for_dow) -> Tuple[pd.DataFrame, pd.DataFrame]:
...
def main() -> int:
    ...
    # alinhar hiperparâmetros (p10_p70)
    wf.POST_Q_OBJ = 0.10
