...
- **PnL semanal médio (bootstrap IC95%)**: **USD 66.6** (IC95% -132.2..293.5)
- **Desvio padrão semanal**: USD 450.8
- **P(semana < 0)**: 56.2%

### Performance OOS (cap2) — excluindo semanas sem trades (stake=0)
- **PnL semanal médio (bootstrap IC95%)**: **USD 71.0** (IC95% -138.5..316.7)
- **Desvio padrão semanal**: USD 466.2
- **P(semana < 0)**: 60.0%
- **ROI on stake agregado (ponderado)**: 0.0230
...
- **FH|quinta-feira**: mean_week=15.7 (IC95% -62.4..114.9), P(semana>0)=25.0%
- **FT|quarta-feira**: mean_week=12.5 (IC95% -89.3..117.2), P(semana>0)=37.5%
- **FH|sábado**: mean_week=4.4 (IC95% -2.9..14.6), P(semana>0)=12.5%
- **FT|sábado**: mean_week=-0.2 (IC95% -28.7..32.3), P(semana>0)=6.2%
