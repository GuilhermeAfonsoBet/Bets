...
- **PnL semanal médio (bootstrap IC95%)**: **USD 235.1** (IC95% -21.3..517.5)
- **Desvio padrão semanal**: USD 568.0
- **P(semana < 0)**: 37.5%

### Performance OOS (cap2) — excluindo semanas sem trades (stake=0)
- **PnL semanal médio (bootstrap IC95%)**: **USD 250.8** (IC95% -19.5..553.9)
- **Desvio padrão semanal**: USD 584.4
- **P(semana < 0)**: 40.0%
- **ROI on stake agregado (ponderado)**: 0.0515
...
- **FH|terça-feira**: mean_week=7.2 (IC95% -14.1..31.5), P(semana>0)=18.8%
