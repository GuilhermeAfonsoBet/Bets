...
- **PnL semanal médio (bootstrap IC95%)**: **USD 192.9** (IC95% -28.7..444.1)
- **Desvio padrão semanal**: USD 499.3
- **P(semana < 0)**: 37.5%

### Performance OOS (cap2) — excluindo semanas sem trades (stake=0)
- **PnL semanal médio (bootstrap IC95%)**: **USD 205.8** (IC95% -34.6..469.3)
- **Desvio padrão semanal**: USD 514.1
- **P(semana < 0)**: 40.0%
- **ROI on stake agregado (ponderado)**: 0.0464
...
- **FT|quarta-feira**: mean_week=18.7 (IC95% -81.6..112.5), P(semana>0)=37.5%
- **FH|quinta-feira**: mean_week=5.6 (IC95% -59.9..80.6), P(semana>0)=31.2%
- **FT|domingo**: mean_week=2.9 (IC95% -5.8..11.5), P(semana>0)=12.5%
- **FH|terça-feira**: mean_week=-0.4 (IC95% -39.7..31.5), P(semana>0)=18.8%
