...
- **PnL semanal médio (bootstrap IC95%)**: **USD 229.7** (IC95% -21.2..501.1)
- **Desvio padrão semanal**: USD 550.9
- **P(semana < 0)**: 31.2%

### Performance OOS (cap2) — excluindo semanas sem trades (stake=0)
- **PnL semanal médio (bootstrap IC95%)**: **USD 245.0** (IC95% -24.3..533.3)
- **Desvio padrão semanal**: USD 566.7
- **P(semana < 0)**: 33.3%
- **ROI on stake agregado (ponderado)**: 0.0653

### Risco no OOS (teste) — portfólio agregado
- p80(soma stakes/dia) = USD 1937 (limite=USD 1610)
- VaR10%(PnL diário) = USD -170.5 (limite >= USD -575)
- P(PnL diário <= -25% banca) = 0.0% (limite <= 10%)

### Ajuste de stake global (α)
- α médio=0.924; p10=0.804; p50=0.999; p90=1.000; P(α<1)=50.0%
...
- **FT|terça-feira**: mean_week=65.9 (IC95% 6.4..134.6), P(semana>0)=43.8%
- **FT|segunda-feira**: mean_week=62.5 (IC95% -7.4..135.5), P(semana>0)=50.0%
- **FT|sábado**: mean_week=60.3 (IC95% 4.9..129.8), P(semana>0)=50.0%
- **FH|sábado**: mean_week=38.9 (IC95% 4.1..81.1), P(semana>0)=43.8%
- **FT|quarta-feira**: mean_week=28.6 (IC95% -75.1..135.1), P(semana>0)=37.5%
- **FH|quinta-feira**: mean_week=10.4 (IC95% -56.2..94.5), P(semana>0)=31.2%
- **FT|domingo**: mean_week=-0.2 (IC95% -4.3..3.8), P(semana>0)=6.2%
- **FH|terça-feira**: mean_week=-1.7 (IC95% -36.6..28.3), P(semana>0)=12.5%
