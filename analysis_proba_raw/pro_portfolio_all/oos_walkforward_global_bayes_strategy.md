...
- **PnL semanal médio (bootstrap IC95%)**: **USD 212.7** (IC95% -16.5..478.5)
- **Desvio padrão semanal**: USD 524.2
- **P(semana < 0)**: 37.5%

### Performance OOS (cap2) — excluindo semanas sem trades (stake=0)
- **PnL semanal médio (bootstrap IC95%)**: **USD 226.8** (IC95% -24.3..505.7)
- **Desvio padrão semanal**: USD 539.4
- **P(semana < 0)**: 40.0%
- **ROI on stake agregado (ponderado)**: 0.0505
...
- **FH | terça-feira**: active_rate=37.5%, ok_rate=37.5%, stake_frac_médio=0.94%, cutoff_médio=0.77
...
- **FT|terça-feira**: mean_week=61.9 (IC95% 5.6..125.6), P(semana>0)=43.8%
- **FT|sábado**: mean_week=55.9 (IC95% -5.1..123.9), P(semana>0)=37.5%
- **FT|quarta-feira**: mean_week=28.7 (IC95% -79.9..139.0), P(semana>0)=37.5%
- **FH|sábado**: mean_week=28.3 (IC95% -10.5..73.3), P(semana>0)=43.8%
- **FH|terça-feira**: mean_week=7.2 (IC95% -14.0..31.5), P(semana>0)=18.8%
