...
- **PnL semanal médio (bootstrap IC95%)**: **USD 169.4** (IC95% -118.4..496.8)
- **Desvio padrão semanal**: USD 645.5
- **P(semana < 0)**: 50.0%

### Performance OOS (cap2) — excluindo semanas sem trades (stake=0)
- **PnL semanal médio (bootstrap IC95%)**: **USD 169.4** (IC95% -117.9..492.1)
- **Desvio padrão semanal**: USD 645.5
- **P(semana < 0)**: 50.0%
- **ROI on stake agregado (ponderado)**: 0.0421

### Risco no OOS (teste) — portfólio agregado
- p80(soma stakes/dia) = USD 1537 (limite=USD 1610)
