...
export DAILY_WF_SELECTION_MODE="${DAILY_WF_SELECTION_MODE:-oos}"
export DAILY_WF_INSAMPLE_DAYS="${DAILY_WF_INSAMPLE_DAYS:-45}"
DEFAULT_ROI_MIN="0"
if [[ "$DAILY_WF_SELECTION_MODE" == "insample" ]]; then
  # No in-sample, o alvo operacional pedido é ROI > 2%.
  DEFAULT_ROI_MIN="2"
  export DAILY_WF_TRAIN_DAYS="${DAILY_WF_TRAIN_DAYS:-45}"
  export DAILY_WF_STEP_DAYS="${DAILY_WF_STEP_DAYS:-7}"
fi
...
export DAILY_WF_ROI_MIN_ACTIVATE="${DAILY_WF_ROI_MIN_ACTIVATE:-$DEFAULT_ROI_MIN}"
...
echo "[INFO] DAILY_WF_SELECTION_MODE=$DAILY_WF_SELECTION_MODE"
echo "[INFO] DAILY_WF_INSAMPLE_DAYS=$DAILY_WF_INSAMPLE_DAYS"
