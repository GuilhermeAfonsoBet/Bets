...
**Data da execução:** 18/02/2026 21:15 UTC  
...
- **Amostra**: 4004 auditorias (jogos únicos=328, média=12.2 obs/jogo); betslip confiável=1809.
- **Janela efetiva (audited_at)**: 12/02 18:29 → 18/02 21:12 UTC (span≈6.1d; dias com dados=7).
...
|---|---:|---:|
| Total de observações | 4004 | 0 |
| Com betslip confiável | 1809 | 0 |
| Com CLV pre-match (betslip) | 938 | 0 |
| Com ROI (betslip) | 1566 | 0 |
| Tempo total observado (detecção→betslip, wall/total) | 12337 ms | — ms |
...
|---|---|---:|---:|---:|---:|
| API (2-4s) | lag_det→click | 5586 | 797 | 7202 | 4002 |
| API (2-4s) | lag_click→betslip | 2627 | 2172 | 4510 | 3406 |
| API (2-4s) | lag_e2e (soma) | 8817 | 3462 | 11102 | 3404 |
| API (2-4s) | audit_total (duração) | 12332 | 4527 | 31183 | 4004 |
...
|---|---:|---:|---|
| Observações totais com classificação temporal | 1857 | 2147 | Contagem bruta do corte |
...
| IN_MATCH | 2147 | 762 | 762 | 226 | 137 | +0.926% |
...
| Dias OOS usados | 1 |
| Turnover 30d (proj.) | 22134.02 |
| Turnover 30d (Pre/In) | 89473.54 / 0.00 |
| Lucro 30d (obs.) | 4403.46 |
| Lucro 30d (obs.) Pre/In | 5361.72 / 0.00 |
| Lucro 30d (exp.) | 4883.36 |
| Lucro 30d (exp.) Pre/In | 5873.64 / 0.00 |
| Banca risco p99 (Back+Lay) | 737.80 |
| Banca liquidez p99 (+buf) | 492.56 |
| Banca recomendada (max) | 737.80 |
| ROI/banca 30d (obs.) | 596.84% |
| ROI/banca 30d (exp.) | 661.88% |
| DD 30d p95 (obs.) | 0.00 |
| DD 30d p95 (exp.) | 0.00 |
...
Referência de banca p/ budget: 737.80 | budgets por jogo aplicados em stake (Back) e liability (Lay).

| Cenário | Turnover 30d | Lucro 30d (exp.) | Banca rec. (max) | ROI/banca 30d (exp.) | DD 30d p95 (exp.) |
|---|---:|---:|---:|---:|---:|
| BASELINE (sem budget) | 22134.02 | 4883.36 | 737.80 | 661.88% | 0.00 |
| BUDGET_0.50%/0.25% cap25% | 1466.38 | 295.35 | 48.88 | 604.25% | 0.00 |
| BUDGET_1.00%/0.50% cap33% | 3800.41 | 859.61 | 126.68 | 678.56% | 0.00 |
| BUDGET_2.00%/1.00% cap50% | 10600.39 | 2296.65 | 353.35 | 649.97% | 0.00 |
| BUDGET_3.00%/1.50% cap33% | 11379.51 | 2554.56 | 379.32 | 673.46% | 0.00 |
| BUDGET_4.00%/2.00% cap33% | 15100.76 | 3339.48 | 503.36 | 663.44% | 0.00 |
| BUDGET_3.00%/1.50% cap50% | 15744.86 | 3373.56 | 524.83 | 642.79% | 0.00 |
| BUDGET_4.00%/2.00% cap50% | 20725.02 | 4402.05 | 690.83 | 637.21% | 0.00 |
...
|---|---:|---:|---:|---:|---|
| Back_Pre_Any | 1 | 36 | 55 | 54.23 | budget reduz concentração por jogo |
