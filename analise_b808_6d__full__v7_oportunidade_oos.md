...
**Data da execução:** 17/02/2026 12:54 UTC  
...
- **Amostra**: 3434 auditorias (jogos únicos=300, média=11.4 obs/jogo); betslip confiável=1739.
- **Janela efetiva (audited_at)**: 11/02 12:58 → 17/02 09:51 UTC (span≈5.9d; dias com dados=7).
- **Coortes (status=OK, betslip confiável)**: `BS>WS` (diff>=2.0%): **606**; `BS<WS` (diff<=-2.0%): **221**.
- **Coberturas em `hypothesis_details` (OK)**: temporal(back)=1288/1739; lay_temporal=1168/1739; finance=1058/1739.
- **Cobertura de placar (ROI)**: jogos com placar=253/300 (status finished=253).
- **Cobertura de closing_odd (AH)**: jogos com closing=150/300 (50.0%). CLV pre‑match depende disso.
...
| Indicador | Valor |
|---|---:|
| Auditorias H3B `UP` (match + kickoff passado) | 3434 |
| Betslip bruto | 2815 |
| Betslip confiável (diff -10% a +10%) | 1739 |
| Descartados no filtro de qualidade | 1076 |
| Jogos únicos (geral) | 300 |
| Média de observações por jogo | 11.4 |
| Jogos únicos com betslip confiável | 287 |
| Distribuição por market_type | AH=3434 |
| Jogos únicos (AH) no recorte | 300 |
| Jogos únicos (AH) com closing_odd disponível | 150 |
| Cobertura closing_odd (AH) | 50.0% |

---
## 2) Base comparativa: API vs DOM
| Métrica | API (v4.0-api) | DOM (v1.0) |
|---|---:|---:|
| Total de observações | 3434 | 0 |
| Com betslip confiável | 1739 | 0 |
| Com CLV pre-match (betslip) | 748 | 0 |
| Com ROI (betslip) | 1535 | 0 |
| Tempo total observado (detecção→betslip, wall/total) | 16579 ms | — ms |
| Tempo instrumentado (detecção→clique→betslip) | 8566 ms | — ms |
...
|---|---|---:|---:|---:|---:|
| API (2-4s) | lag_det→click | 5981 | 823 | 7557 | 3434 |
| API (2-4s) | lag_click→betslip | 2601 | 2138 | 4297 | 3354 |
| API (2-4s) | lag_e2e (soma) | 8566 | 3420 | 9868 | 3354 |
| API (2-4s) | audit_total (duração) | 16575 | 4765 | 57586 | 3434 |
| API (2-4s) | overhead (total - e2e) | 8178 | 305 | 33774 | 3354 |
...
|---|---:|---:|---|
| Observações totais com classificação temporal | 1291 | 2143 | Contagem bruta do corte |
| ROI Betslip | 815 | 720 | Amostra com resultado do jogo |
| ROI WebSocket | 1160 | 1859 | Referência de mercado |
...
|---|---:|---:|---:|---:|---:|---:|
| PRE_MATCH | 1291 | 898 | 898 | 345 | 64 | +2.115% |
| IN_MATCH | 2143 | 841 | 841 | 261 | 157 | +0.976% |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| < 5s | 1120 | 240 | 3581 | 4850 | 2507 | 362 | 131 | +2.22% [+1.73%, +2.71%] | +2.80% [-3.40%, +9.21%] |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| < 5s | 1120 | 362 | 131 | +6.90% [+6.42%, +7.38%] | -3.74% [-4.92%, -2.54%] | +1.75% [-9.01%, +12.55%] | +3.27% [-12.09%, +18.53%] |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| 2026-02-11 | API (2-4s) | 159 | 57 | 39.0% | 17.6% | 27128 | +7.02% | -4.08% |
...
| Métrica | API | DOM |
|---|---:|---:|
| ROI Betslip | +1.138% (NS, N=1533) | — (N/A, N=0) |
| ROI WebSocket | -0.370% (NS, N=3003) | — (N/A, N=0) |
| Win rate ROI Betslip | 50.7% | —% |
| Win rate ROI WS | 50.1% | —% |

Notas de robustez (IC 90% por jogo):  
- API ROI betslip (cluster): média +0.731%; IC90 [-4.284%, +5.903%]  
- API ROI WS (cluster): média -2.092%; IC90 [-4.502%, +0.207%]  

---
## 5) Diferença de preço BS vs WS
| Métrica | API | DOM |
|---|---:|---:|
| Diff BS vs WS (média) | +1.564% (sig. positivo, N=1739) | — (N/A, N=0) |
| BS > WS | 46.6% (810/1739) | —% (0/0) |
| BS > WS +2% | 34.8% (606/1739) | —% (0/0) |
...
| BS ~ WS (-2% a +2%) | 912 | -0.118% | [-0.599%, +0.276%] | 403 | 109 | +0.144% | [-9.355%, +3.027%] |
| BS > WS (+2% a +10%) | 606 | +6.647% | [+6.334%, +7.204%] | 294 | 91 | +1.615% | [-2.538%, +14.594%] |
...
| AH 1-2 (média) | +2.032% | [+1.017%, +3.534%] | +3.188% | [-11.777%, +14.379%] | +2.152% |
| AH 2+ (extrema) | +2.187% | [+0.554%, +2.411%] | +0.645% | [-8.516%, +6.766%] | +1.182% |
...
|---|---:|---|---:|---:|---:|---|---:|
| < 10s | +2.370% | [+1.607%, +2.607%] | 535 | 113 | +1.162% | [-4.785%, +7.308%] | +1.472% |
...
| stake_cap | 0.00 |
| Cobertura finance (OK, betslip conf.) | 1058/1739 |
...
| Corte (diff_pct) | >= 2.0% |
| N eventos | 606 |
| Cobertura finance (na coorte) | 355/606 |
| Stake total (estimado) | 213474.41 |
| Stake médio | 352.27 |
| Profit_if_win total (estimado) | 229334.88 |
| Profit_if_win médio | 378.44 |
...
|---|---:|---:|---:|---:|
| Back | 6.0 | 1067372.05 | -217725.09 | -223994.28 |
| Lay (stake) | 6.0 | 205435.62 | -15422.88 | -16419.33 |
| Total (Back+Lay) | 6.0 | 1272807.68 | -233147.98 | -240413.61 |
...
|---|---:|---:|---:|---:|
| Back (stake) | 4399.21 | 4132.71 | -4949.19% | -5091.70% |
| Lay (liability) | 2053.93 | 1663.71 | -750.89% | -799.41% |
| Total (soma) | 6453.14 | 5796.43 | -3612.94% | -3725.53% |
...
|---|---:|---:|---:|---:|---:|
| Back (stake) | 18352.20 | 51230.12 | 74135.81 | 80021.28 | 81549.40 |
| Lay (liability) | 2441.64 | 6164.06 | 8829.27 | 9058.33 | 9712.19 |
| Total (Back+Lay) | 20780.26 | 54433.44 | 80298.34 | 86161.01 | 88328.17 |

**Banca recomendada (conservadora)**

| Métrica | Valor |
|---|---:|
| Banca por risco (p99 unitário, soma) | 6453.14 |
| Banca por liquidez (p99 simultâneo + buffer) | 88328.17 |
| Banca efetiva (max das duas) | 88328.17 |
| ROI/banca 30d (direto, banca efetiva) | -263.96% |
| ROI/banca 30d (ROI×turnover, banca efetiva) | -272.18% |
**Diagnóstico de cobertura (placar/ROI)**

| Bloco | Turnover total | Turnover com ROI | Cobertura turnover |
|---|---:|---:|---:|
| Back | 213474.41 | 207499.66 | 97.20% |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| PRE_MATCH | 898 | 4.2 | 5.2 | 77.4% | 15.8% | 12.3 | 7.3 |
...
|---|---:|---:|---:|---:|---:|
| t+0s | 1739 | +1.56% | 2.013 | +2.28% | 1.91 |
...
|---|---:|---:|---:|---:|---:|
| SEM_REVERSAO | 1354 | 627 | +1.73% [+1.20%, +2.25%] | +2.00% [+1.48%, +2.51%] | +1.99% [+1.47%, +2.50%] |
...
|---|---:|---:|---:|---:|---:|
| SEM_REVERSAO | 1354 | 1202 | +0.33% [-5.55%, +6.52%] | +0.44% [-5.57%, +6.66%] | +0.42% [-5.59%, +6.64%] |
...
|---|---:|---:|---:|---:|
| SEM_REVERSAO | 627 | 1.983 [+1.971, +1.995] | 1.990 [+1.978, +2.003] | 1.969 [+1.961, +1.978] |
...
| Back | Pre | No | 756 | 163 | +1.73% [+1.20%, +2.25%] | -4.93% [-12.67%, +3.06%] | -7.47% | não (CLV p90>0 AND ROI>0) |
...
| Back | KELLY_0.10 | 264 | 6796.40 | 127.22 | 1.87% | 56.18 | 50.69 | 685.82 | 1346.29 |
| Lay | KELLY_0.10 | 40 | 523.67 | 57.41 | 10.96% | 20.54 | 20.54 | 33.66 | 60.90 |
| Back | KELLY_0.25 | 264 | 14199.74 | -47.39 | -0.33% | 87.98 | 87.98 | 1774.98 | 3349.63 |
| Lay | KELLY_0.25 | 40 | 764.41 | 107.73 | 14.09% | 20.54 | 20.54 | 33.78 | 58.97 |
| Back | KELLY_0.50 | 264 | 17621.61 | -204.34 | -1.16% | 87.98 | 87.98 | 2120.61 | 4043.13 |
| Lay | KELLY_0.50 | 40 | 838.36 | 104.81 | 12.50% | 20.54 | 20.54 | 24.15 | 42.73 |
| Back | KELLY_1.00 | 264 | 18248.02 | -164.19 | -0.90% | 87.98 | 87.98 | 2067.82 | 3838.41 |
...
| Back | Pre | Yes | KELLY_0.10 | 61 | 1691.63 | 60.56 | 3.58% | 44.86 | 480.72 |
| Back | Pre | Yes | KELLY_0.25 | 61 | 3768.76 | 86.70 | 2.30% | 87.98 | 1212.82 |
| Back | Pre | Yes | KELLY_0.50 | 61 | 4590.95 | 123.92 | 2.70% | 87.98 | 1410.31 |
| Back | Pre | Yes | KELLY_1.00 | 61 | 4696.37 | 112.17 | 2.39% | 87.98 | 1627.57 |
| Back | Pre | No | FLAT | 248 | 248.00 | -5.31 | -2.14% | 1.00 | 73.64 |
| Back | Pre | No | PROXY | 248 | 131387.15 | -24031.39 | -18.29% | 4491.02 | 197022.52 |
| Back | Pre | No | KELLY_0.10 | 203 | 5104.77 | 66.66 | 1.31% | 57.65 | 897.81 |
| Back | Pre | No | KELLY_0.25 | 203 | 10430.98 | -134.08 | -1.29% | 87.98 | 2473.27 |
| Back | Pre | No | KELLY_0.50 | 203 | 13030.65 | -328.26 | -2.52% | 87.98 | 3197.49 |
| Back | Pre | No | KELLY_1.00 | 203 | 13551.65 | -276.36 | -2.04% | 87.98 | 3028.09 |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| BackFast (<5s, PM) + LayReversal (t_ext<=3s) | FLAT | 197 | 22 | 985 | 110 | 1.00 | 1.10 | 1.00 | 1105.68 | 41.86 | 3.79% | 2.97% | 2.71% | 1.00 | 1.00 | 2.00 | 158.31 | 158.31 | 26.44% | 5749.53 | 217.69 | 823.22 | 41.21 |
| BackFast (<5s, PM) + LayReversal (t_ext<=3s) | KELLY_0.25 | 167 | 18 | 835 | 90 | 55.83 | 17.97 | 15.78 | 48236.90 | 1373.83 | 2.85% | 2.63% | 2.31% | 87.98 | 20.54 | 108.52 | 6969.07 | 6969.07 | 19.71% | 250831.86 | 7143.92 | 36239.14 | 2028.65 |
...
**Escala Kelly usada nesta curva**: P99_PROXY | ref_back=4399.21 ref_lay=2053.93 | cap_back=2.0% cap_lay=1.0% | max_stake_event=100%*limit
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| BackFast+LayReversal | KELLY_0.10 | 0.0% | 13.1% | 4.8% | 4.8% | 22546.33 | 775.08 | 23.63% | 903.64 |
| BackFast+LayReversal | KELLY_0.25 | 19.7% | 25.1% | 57.1% | 4.8% | 48236.90 | 1373.83 | 19.71% | 2034.63 |
| BackFast+LayReversal | KELLY_0.50 | 83.1% | 31.1% | 85.7% | 4.8% | 60577.49 | 1311.70 | 15.09% | 1484.65 |
| BackFast+LayReversal | KELLY_1.00 | 93.4% | 31.7% | 100.0% | 4.8% | 62469.45 | 1809.40 | 20.19% | 1381.79 |
...
| 2026-02-12→2026-02-14 | 2026-02-15→2026-02-15 | 3 | 40 | +3.05% [-16.95%, +24.15%] | 11385.10 | -899.12 | -961.86 |
...
| Dias OOS usados | 2 |
| Turnover 30d (proj.) | 412072.66 |
| Lucro 30d (obs.) | -88589.72 |
| Lucro 30d (exp.) | -89530.80 |
| Banca risco p99 (Back+Lay) | 16039.40 |
| Banca liquidez p99 (+buf) | 12844.74 |
| Banca recomendada (max) | 16039.40 |
| ROI/banca 30d (obs.) | -552.33% |
| ROI/banca 30d (exp.) | -558.19% |
| DD 30d p95 (obs.) | 105020.69 |
| DD 30d p95 (exp.) | 109755.81 |
