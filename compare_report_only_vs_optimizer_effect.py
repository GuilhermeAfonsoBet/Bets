...
def main() -> int:
    ...
    lines.append(f"- **Otimizador (versão atual, novo OOS)**: mean/sem={o['mean_week']:.1f}, Sharpe_ann={o['sharpe_annual']:.3f}, ROI/$={o['roi_on_stake']:.4f}\n\n")
    ...
    lines.append("- Otimizador (versão atual) muda seleção/stakes/cutoffs; portanto muda o realizado OOS.\n\n")
